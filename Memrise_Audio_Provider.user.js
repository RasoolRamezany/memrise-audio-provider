...
// @match          https://www.decks.memrise.com/course/*/garden/*
// @match          https://www.decks.memrise.com/garden/review/*
// @version        0.1.26
...
$(document).ready(function () {
    ...
    decks.MEMRISE.garden._events.start.push(() => {
        language = decks.MEMRISE.garden.session.category.name;
        ...
        decks.MEMRISE.garden.session.make_box = (function () {
            var cached_function = decks.MEMRISE.garden.session.make_box;
            return function () {
        ...
        decks.MEMRISE.renderer.fixMediaUrl = (function () {
            var cached_function = decks.MEMRISE.renderer.fixMediaUrl;
            return function () {
        ...
        decks.MEMRISE.audioPlayer.play = (function () {
            var cached_function = decks.MEMRISE.audioPlayer.play;
            return function () {
        ...
        decks.MEMRISE.garden.populateScreenAudios = function() {
            _.each(decks.MEMRISE.garden.learnables || _.indexBy(decks.MEMRISE.garden.session_data.learnables, 'learnable_id'), function(v, k) {
                var learnableScreens = (decks.MEMRISE.garden.screens || decks.MEMRISE.garden.session_data.screens)[k];
                var screenMap = decks.MEMRISE.garden.screen_template_map[k];
        ...
        decks.MEMRISE.garden.populateScreenAudios();
    });
    ...
    function getCourseId(context) {
        return context.course_id || decks.MEMRISE.garden.session_params.course_id || decks.MEMRISE.garden.session_data.learnables_to_courses[context.learnable.learnable_id];
    }
